...
import { Search, X, Rows3, CheckSquare, Square, Users, Ban } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-3 pb-20">
      ...
      <div className="flex items-center gap-2">
        ...
        <Select value={sort} onChange={e => setSort(e.target.value as SortMode)} className="w-auto shrink-0">
        ...
        <div className="flex shrink-0 items-center gap-1.5 rounded-xl border border-zinc-200 px-2.5 py-1.5 dark:border-zinc-800">
          <Rows3 size={15} className="text-zinc-400" />
          <input type="range" min={0} max={SIZES.length - 1} value={sizeIdx} onChange={e => setSizeIdx(parseInt(e.target.value, 10))} className="w-14 accent-emerald-600 sm:w-20" />
        </div>
      </div>
