...
export type AiTask = 'recategorize' | 'churner_stage1' | 'churner_stage2' | 'ocr' | 'categories_chat' | 'model_review' | 'nlanalytics' | 'bankmatch' | 'statsask' | 'csvmapping' | 'mailreinterpret';
